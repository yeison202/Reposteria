...
$pdf->Cell(5, 10, 'Codigo', 0, 0, 'C', 1);
$pdf->Cell(10, 10, 'Cliente', 0, 0, 'C', 1);
$pdf->Cell(50, 10, 'Fecha', 0, 0, 'C', 1);
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(10, 5, $row['Id_cliente'], 0, 0, 'C');
    $pdf->Cell(65, 5, $row['fecha'], 0, 0, 'C');
    $pdf->Cell(25, 5, $row['total'].'$', 0, 0, 'C');
